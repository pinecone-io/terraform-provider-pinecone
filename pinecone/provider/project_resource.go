...
func (r *ProjectResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	payload := pinecone.CreateProjectParams{
		Name: data.Name.ValueString(),
	}

	project, err := r.client.Projects().CreateProject(&payload)
	if err != nil {
...
func (r *ProjectResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	index, err := r.client.Projects().FetchProject(data.Id.ValueString())
	if err != nil {
...
func (r *ProjectResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Projects().DeleteProject(data.Id.ValueString())
	if err != nil {
